...
public class VerificadorNumeroConta {
    ...
    private static void verificarNumeroConta(String numeroConta) {
        if (numeroConta.length() != 8) {
            ...
            //String mensagem = "Numero de conta invalido. Digite exatamente 8 digitos.";
            //throw new IllegalArgumentException("Numero de conta invalido. Digite exatamente 8 digitos.", null);
